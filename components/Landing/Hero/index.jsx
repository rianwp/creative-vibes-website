const Hero = () => {
  return (
    <div className={`-mt-14 w-full landscape:h-screen portait:hero-responsive bg-gradient-to-br from-cyan-300 via-purple-600 to-pink-600 flex flex-col items-center justify-center`}>
